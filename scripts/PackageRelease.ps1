...
$portableDirectory = Join-Path $projectRoot "artifacts\portable\QuickSnip-0.8.0-win-x64"
$portableArchive = Join-Path $releaseDirectory "QuickSnip-Portable-0.8.0-win-x64.zip"
...
Copy-Item -LiteralPath (Join-Path $projectRoot "artifacts\installer\QuickSnip-Setup-0.8.0-win-x64.exe") `
